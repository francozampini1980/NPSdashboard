...
export default function PostEntregaTab() {
  ...
  const reset = () => {
    ...
    setCesAspects(EMPTY_ASPECTS)
    setNpsNegativeAspects(EMPTY_ASPECTS)
          ...
          <div className="mt-4 bg-emerald-50 border border-emerald-200 rounded-xl p-4 space-y-5">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              {[
                ...
                { label: 'NPS', value: `${pendingData.nps_score > 0 ? '+' : ''}${pendingData.nps_score}` },
                { label: 'CES', value: pendingData.ces_score.toFixed(1) },
